...
class OenologistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create oenologist" do
    assert_difference('Oenologist.count') do
      post oenologists_url, params: { oenologist: { age: @oenologist.age, editor: @oenologist.editor, name: @oenologist.name, nationality: @oenologist.nationality, reviewer: @oenologist.reviewer, writer: @oenologist.writer } }
    end
  ...
  test "should update oenologist" do
    patch oenologist_url(@oenologist), params: { oenologist: { age: @oenologist.age, editor: @oenologist.editor, name: @oenologist.name, nationality: @oenologist.nationality, reviewer: @oenologist.reviewer, writer: @oenologist.writer } }
